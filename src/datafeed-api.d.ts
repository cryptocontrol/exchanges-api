...
export interface IUdfResponse {
  s: string
}


export interface IUdfOkResponse extends IUdfResponse {
  s: 'ok'
}


export interface IUdfErrorResponse {
  s: 'error'
  errmsg: string
}


interface HistoryPartialDataResponse extends IUdfOkResponse {
  t: number[]
  c: number[]
  o?: never
  h?: never
...
interface HistoryFullDataResponse extends IUdfOkResponse {
  t: number[]
  c: number[]
  o: number[]
  h: number[]
...
interface HistoryNoDataResponse extends IUdfResponse {
  s: 'no_data'
  nextTime?: number
}
...
export interface ISearchSymbolResultItem {
	symbol: string;
	full_name: string;
	description: string;
	exchange: string;
...
export declare type SearchSymbolsCallback = (items: ISearchSymbolResultItem[]) => void;
export declare type ResolveCallback = (symbolInfo: LibrarySymbolInfo) => void;
export declare type HistoryCallback = (bars: Bar[], meta: IHistoryMetadata) => void;
